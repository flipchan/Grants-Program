...
XcmSend aims to be a public Xcm asset sending website. Making it easy for end users to send assets from one parachain to another using Xcm.

XcmSend is your open-source solution for seamless asset transfers across parachains. Powered by the XCM language, our user-friendly platform simplifies cross-chain transactions for regular users and DeFi enthusiasts.
...
The team has delivered previous projects for the web3 foundation(Ramsey), The polkadot Treasury(flipchan) and Edgeware’s Treasury.
